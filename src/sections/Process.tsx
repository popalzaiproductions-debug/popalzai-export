            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="md:col-span-4">
                  {step.image ? (
                    <div className="img-hover" style={{ aspectRatio: '4/3', borderRadius: '2px', overflow: 'hidden', border: '1px solid var(--rule)' }}>
                      <img
                        src={step.image}
                        alt={step.title}
                    ...
                    >
                      <span className="eyebrow" style={{ fontSize: '0.55rem', color: 'var(--ink-faint)' }}>KIMI_REF: production floor detail</span>
                    </div>
                  )}
                </div>
              </div>
