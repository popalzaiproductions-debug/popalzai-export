...
$SPEC = @{
  ...
  'hoodie'     = @{ pa=@(696,260,363,300); pl=@(@(921,275,91),@(742,275,91),@(726,300,303),@(696,260,363)) }
  'ziphoodie'  = @{ pa=@(640,260,345,200); pl=@(@(852,280,91),@(682,280,91)) }
  'jeans'      = @{ pa=@(62,115,116,700);  pl=@(@(70,120,110),@(70,230,110),@(40,700,110)) }
